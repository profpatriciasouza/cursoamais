                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    if (Security::get('tipo') == 'awersaw') {
                                                        ...
                                                        if ($destinatarios) {
                                                            ...
                                                            <select type="text" name='destinatario' class="form-control" placeholder="Informe o título do seu email">
                                                                <?php
                                                                foreach($destinatarios as $destinatario) {
                                                                    ?>
                                                                <option value='<?php echo $destinatario->usuario_email; ?>'><?php echo $destinatario->Usuario_Nome; ?></option>
                                                                <?php
                                                                }
                                                                ?>
                                                            ...
                                                            <div class="input-group m-bot15">
                                                                ...
                                                                <input type="text" name='destinatario' class="form-control" placeholder="Username">
                                                            </div>
