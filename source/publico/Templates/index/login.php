        ...
        <div class="container">
            ...
            <form id="formLogin" class="form-signin" method="POST" action="<?php echo $this->url("login"); ?>">
                ...
                <div class="login-wrap">
                    ...
                    Error::showAlerts();
                    ?>
                    <input type="text" name="Usuario" class="form-control" placeholder="Informe seu usuário" autofocus="" />
                    ...
                    <div class="row">
                        <div class="col-xs-12 text-center" >
                            <a style="color: #6bc5a4;" href="<?php echo $this->url("esqueci-minha-senha"); ?>" class="btn-esqueci-minha-senha">esqueci minha senha</a>
                        </div>
                    </div>
                </div>
            </form>
